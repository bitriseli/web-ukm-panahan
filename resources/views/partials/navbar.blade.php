        ...
        <div class="modal-item modal fade" id="targetModal-item" tabindex="-1" role="dialog"
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content border-0">
              <div class="modal-header border-0" style="padding: 2rem; padding-bottom: 0; background-color: #cfe6da">
                <!-- <a class="modal-title" id="targetModalLabel">
                                                  </a> -->
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
              </div>
              <div class="modal-body" style="padding: 2rem; padding-top: 0; padding-bottom: 0; background-color: #cfe6da">
                <ul class="navbar-nav responsive me-auto mt-2 mt-lg-0">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="info-daftar.html">Pendaftaran</a>
                  </li>
                </ul>
              </div>
